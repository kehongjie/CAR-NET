setting_ui <- function(id, label = "global settings") {
  ...
  tabPanel("Overview", value=id,
           ...
           fluidRow(
             img(src='flowchart.png',align="center",width="1000"),
             ...
             p("Our tool is available for download on github: ",a(strong("NGRN"), href="https://github.com/weiiizong/CAMO_Rshiny",target="_blank"), ".", 
