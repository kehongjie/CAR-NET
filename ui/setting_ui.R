setting_ui <- function(id, label = "global settings") {
  ...
  tabPanel("Overview", value=id,
           h2("Welcome to CAR-NET",align = "middle",style="primary"),
           tags$hr(),
           #HTML('<center><img src="Rshiny_flowchart.png" width="500" </center>'),
           fluidRow(
             h3("Introduction"),
             p("CAR-NET is an analytical software with R-Shiny based graphical user interface (GUI) tool to construct noncoding RNA-gene regulatory network from expression data."),
             ...
             p("Our tool is available for download on github: ",a(strong("CAR-NET"), href="https://github.com/kehongjie/CAR-NET",target="_blank"), ".", 
...
blob/master/CAMO_turtorial.pdf",target="_blank")), 
             p("CAR-NET is developed and maintained by ", a("Dr. Tianzhou (Charles) Ma's group ",href="https://matianzhou.github.io",target="_blank"), "(Department of Epidemiology and Biostatistics, University of Maryland College Park)."),
